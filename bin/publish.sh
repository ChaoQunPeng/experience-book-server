###
 ...
 # @LastEditTime: 2024-02-29 21:20:48
 # @FilePath: /experience-book-server/bin/publish.sh
 # @Description: 
### 

cp -R ./bin /Users/pengchaoqun/code/experience-book/experience-book-host/server/
cp -R ./http /Users/pengchaoqun/code/experience-book/experience-book-host/server/
...
cp -R ./healthcheck.js /Users/pengchaoqun/code/experience-book/experience-book-host/server/
cp -R ./package.json /Users/pengchaoqun/code/experience-book/experience-book-host/server/
cp -R ./package-lock.json /Users/pengchaoqun/code/experience-book/experience-book-host/server/